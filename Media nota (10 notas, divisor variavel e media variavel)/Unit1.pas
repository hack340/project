...
var
  ...
  divisor: real;
begin
// validação dos campos de nota, media e divisor, so funciona se for antes de receber as variaveis.
...
//verificar se está dentro da media e mostrar se esta aprovado.
  if resultado >= media
  then
    if resultado > 0
    then
